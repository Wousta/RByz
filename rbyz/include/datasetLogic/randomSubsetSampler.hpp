...
public:
    ...
    explicit RandomSubsetSampler(std::vector<size_t> indices, std::optional<uint64_t> seed = std::nullopt)
    ...
    const std::vector<size_t>& get_last_batch_indices() const {
        return last_batch_indices_;
    }
    ...
    void save(torch::serialize::OutputArchive& archive) const override {
        ...
        torch::Tensor seed_tensor = torch::tensor(static_cast<int64_t>(generator_.default_seed), torch::kInt64);
    ...
    void load(torch::serialize::InputArchive& archive) override {
        ...
        std::memcpy(temp_indices.data(), indices_tensor.data_ptr<int64_t>(), indices_numel * sizeof(int64_t));
        ...
        std::memcpy(temp_shuffled.data(), shuffled_indices_tensor.data_ptr<int64_t>(), shuffled_numel * sizeof(int64_t));
