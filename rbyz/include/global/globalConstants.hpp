...
inline constexpr int CLNT_IMAGES_IDX = 8;
inline constexpr int CLNT_LABELS_IDX = 9;
inline constexpr int CLNT_FORWARD_PASS_IDX = 10;
inline constexpr int CLNT_FORWARD_PASS_INDICES_IDX = 11;
